  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 pb-20">
      <header className="mb-10">
        <h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Esplora</h2>
        <p className="text-zinc-400">Trova i tuoi prossimi titoli preferiti</p>
      </header>

      <form onSubmit={handleSearch} className="bg-zinc-900 p-8 rounded-lg border border-zinc-800 shadow-2xl mb-16 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-widest text-zinc-400 mb-2.5 ml-1">Categoria</label>
        ...
        <div className="space-y-10">
          <div className="flex justify-between items-end border-b border-zinc-800 pb-4">
            <div>
              <h3 className="text-2xl font-bold text-white tracking-tight">
                {isDiscovery ? 'Titoli del momento' : 'Risultati della ricerca'}
              </h3>
              <p className="text-zinc-500 text-sm mt-1">{totalResults} titoli trovati</p>
            </div>
          </div>
          ...
          {loadingMore && (
            <div className="flex flex-col items-center justify-center py-12 gap-4">
              ...
              <p className="text-red-600 font-bold text-xs uppercase tracking-widest animate-pulse">Caricamento titoli...</p>
            </div>
          )}
      ...
      {movies.length === 0 && !loading && !error && (
        <div className="text-center py-32 bg-zinc-900/20 border border-zinc-800 rounded-lg">
          ...
          <p className="text-zinc-500 font-medium tracking-widest uppercase text-sm">Cerca un titolo per iniziare</p>
        </div>
      )}
    </div>
  )
